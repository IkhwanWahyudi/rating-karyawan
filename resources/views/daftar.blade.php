            ...
            <div class="bg-slate-700 p-10 rounded-md">
                <form action="{{ route('daftar.action') }}" method="post">
                    ...
                    <div class="w-[250px] flex place-content-center pb-5">
                        <p class="flex items-center text-white">Daftar Akun Perusahaan</p>
                    </div>
                        ...
                        <div class="w-[250px] relative">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-slate-600">
                    ...
                    <button type="submit"
                        class="w-[250px] h-auto py-2 mt-5 text-white hover:text-black font-medium bg-slate-600 hover:bg-slate-500 rounded-md flex justify-center items-center hover:bg-[#f68812de]">Daftar</button>
                </form>
                <a href="/" class="text-blue-600 py-2">Login</a>
            </div>
        </div>
    </div>
@endsection
